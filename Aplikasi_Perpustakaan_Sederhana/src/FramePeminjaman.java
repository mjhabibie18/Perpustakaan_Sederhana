...
public class FramePeminjaman extends javax.swing.JDialog {

    public FramePeminjaman(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Tanggal_sekarang();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FramePeminjaman dialog = new FramePeminjaman(new javax.swing.JFrame(), true);
