...
public class FrameMahasiswa extends javax.swing.JDialog {

    public FrameMahasiswa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tampil_tb_mahasiswa();
    }

    FrameMahasiswa(FramePeminjaman aThis, boolean rootPaneCheckingEnabled) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrameMahasiswa dialog = new FrameMahasiswa(new javax.swing.JFrame(), true);
